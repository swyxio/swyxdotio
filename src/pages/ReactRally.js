...
function ReactRally() {
  return (
    ...
    >
      ...
      <p>
        diving into React's push-pull data flow and the importance of the
        scheduler:
      </p>
      <p>
        Feedback:{' '}
      ...
      <ul>
        <li>
          ...
          (and{' '}
          <A href="https://www.youtube.com/watch?v=ZZoB5frlcnE&feature=youtu.be">
            ReactNYC
          </A>)
        </li>
        <li>
          Github:
          <A href="https://github.com/sw-yx/reactive-react">reactive-react</A>
        </li>
        <li>
          Slides:
        ...
        <li>
          ...
          <ul>
            <li>
              "Hey! Just wanted to say as a dev who's aspiring to continuously
              improve that your talk was amazing."
            </li>
            <li>
              "enjoyed your talk! I've been really reading into message queue
              usage in microservices and so its nice to see it explained in
              front-end context on while that model makes sense. thanks!"
            </li>
