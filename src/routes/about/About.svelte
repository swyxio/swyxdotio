...
<article class="text-teal-400">
  ...
  <div class="prose py-4">
    ...
    <p>
      Links: <a href="https://twitter.com/swyx">Twitter</a>, <a
        href="https://github.com/sw-yx">GitHub</a>. Pictures: <a
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              <div>
                Luck is random, but creating luck is a skill that can be
                developed.
              </div>
            </li>
            <li>
            ...
            <li>
              ...
              <div>
                Talking about why and when Single File Components are slowly
                coming to React.js
              </div>
            </li>
            <li>
  ...
  <div class="prose">
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          I helped moderate <a
            href="https://www.swyx.io/writing/react-survey-2019/">/r/reactjs</a>
          to 200k+ developers, and <a
            href="https://twitter.com/sveltesociety">cofounded Svelte Society</a>.
        </p>
        <div>
          I led CLI development for <a
            href="https://news.ycombinator.com/item?id=19615546">Netlify Dev</a>,
          <a
            href="https://github.com/netlify/plugins/blob/master/plugins.json">Build
            Plugins</a> and other open source tooling at Netlify. I've also helped
          maintain other OSS projects like <a
