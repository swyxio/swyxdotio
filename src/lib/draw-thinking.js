...
Use native editable text/shapes and genuinely bound arrows, not raster images. Prefer dark neutral structure (#10243b), pale or transparent fills, generous whitespace, and one semantic accent (blue #155f9b or green #346b4e); use orange #e14d2a for a meaningful warning/objection, not random decoration. Light hand-drawn linework (roughness 1), solid pale fills, short direct labels, title 30–38 and main labels 23; 17 only for brief secondary annotations at roughly 1000 units of figure width. Keep 48+ outer padding and 64–96 between main nodes. Color, arrows, ordering and containment must carry meaning. Respect the user's explicit style request instead of forcing these defaults on every drawing.
