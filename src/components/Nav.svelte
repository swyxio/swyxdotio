...
<nav
	class="relative mx-auto flex w-full max-w-4xl items-center justify-between border-gray-200 bg-gray-50 bg-opacity-60 py-8 text-gray-900 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 sm:pb-16"
>
	...
	<ul class="ml-[-0.60rem] flex">
		...
		<li><NavLink href="/subscribe">Subscribe</NavLink></li>
	</ul>
	<div class="flex items-center space-x-4">
		...
		<a
			...
			target="_blank"
			rel="me noopener"
			class="mr-2 rounded-lg text-gray-700 hover:bg-yellow-200 dark:text-gray-200 dark:hover:bg-yellow-800"
		>
