...
<nav
  ...
  <div class="flex items-center flex-1">
    <div class="flex items-center justify-between w-full md:w-auto">
      ...
      sm:text-base lg:text-sm xl:text-base">
        <a
          ...
          Shawn
          <span
            class="font-bold text-indigo-800 dark:text-indigo-200 opacity-75">@Swyx</span>
          Wang
        </a>
      </div>
    </div>
    <div class="hidden space-x-10 md:flex md:ml-10">
      <a
        href="/ideas"
        class="font-medium text-indigo-800 dark:text-indigo-400 dark:hover:text-red-800 hover:text-red-500 transition
      ...
      <div
        ...
        <div class="space-y-1 px-2 pt-2 pb-3">
          ...
          <a
            ...
            class="block px-3 py-2 rounded-md text-base font-medium
              bg-purple-200 text-gray-700 hover:text-gray-900
