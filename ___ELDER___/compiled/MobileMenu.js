...
const MobileMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<nav class="${"relative max-w-screen-xl mx-auto flex items-center justify-between px-4 sm:px-6"}"><div class="${"flex items-center flex-1"}"><div class="${"flex items-center justify-between w-full md:w-auto"}"><a href="${"/"}" aria-label="${"Home"}" class="${"text-white"}">swyx.io </a>
