...
const Showcase = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"relative max-w-lg mx-auto lg:max-w-7xl mb-8"}"><div class="${"text-center"}"><h2 class="${"text-3xl leading-9 tracking-tight font-extrabold text-gray-200\n        sm:text-4xl sm:leading-10"}">Idea Showcase
    </h2>
