...
No docs is bad. More docs is good. A pile of disorganized, out of date docs is bad.
...
- Project Status
  ...
  - there is research that shows that the kind of maintainer that adds more maintenance badges is correlated with better project quality
...
- Recovering from Failure
  - Common Mistakes (incl pre-emptive warnings)
...
- Build Docs into the tool
  - dev-mode warnings
  - minified production error codes
...
- **Level 0: Basic proof of concept (audience: you/colleagues/hobbyists)**
  - **One sentence description for github headline**
...
- **Level 1: v0.x**
  ...
  - Install + Config Instructions
- **Level 2: v1**
  - Example audience: brownfield early adopters. Ok with bugs, they have some problem that isnt well addressed
  - Comparison vs comparable libraries
  - Problem Statement - what you solve, how the developer/end user is better off with your thing than handwritten. aka Why You Exist
  - Live Demos
- **Level 3: vX**
  - Example audience: early majority user. Wants ease of use, quick wins.
...
- **Level 4: Production use for multiple years**
  - Example audience: expert user. Wants stability, deep insight.
  - Growing the Meta
    - Origin Story/Naming
    - Who Uses Us
      - Logos
...
- **Level 5: Community of Production users**
  - Example audience: Industry beginner. They may not know any alternatives. You are the world to them.
  - "1 to N" Docs
    - Different docs for different audiences (eg JS/Android/iOS)
    - Different languages
  - Examples
